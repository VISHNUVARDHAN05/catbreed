...
classes = [ 'System Detected as Maine coon Cat',
           'System Detected as bengal cat',
            'System Detected as Bombay Cat',
           'System Detected as sphynx Cat']
...
def userlog():
    ...
    if request.method == "POST":
        ...
        print('p')
        mydb = mysql.connector.connect(host="localhost", user="root", passwd="", database="cat_breed")
        cursor = mydb.cursor()
...
def upload():
    ...
    fn=myfile.filename
    mypath=os.path.join('D:/Fathima/Python/cat breed/images/', fn)
    myfile.save(mypath)
    ...
    img="dataset1/train_set/bombay cat/22985348_7380.jpg"
    new_model = load_model(r"D:\Fathima\Python\cat breed\MobileNet.h5")
...
def send_image(filename):
    print("hello world")
    return send_from_directory(r"D:\Fathima\Python\cat breed\images", filename)
@app.route('/upload1')
def upload1():
